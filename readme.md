...
**Ben NOCHÉ** — Data & Analytics Engineer · [**datamaieutic**](https://www.linkedin.com/in/bennoche)
...
A portfolio project by [**datamaieutic**](https://www.linkedin.com/in/bennoche) — every component is documented with the *why* behind each architecture decision, including **the real errors encountered** and their fixes. Because a pipeline that works on the first try teaches nobody anything.
...
**Ben NOCHÉ** — Data & Analytics Engineer · [**datamaieutic**](www.linkedin.com/in/ben-noché)
